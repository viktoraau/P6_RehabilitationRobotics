...
jedi_game.launch.py
-------------------
Stand-alone launcher for the Jedi Deflect game.

Joints used:
  index 1 – y / FE  (vertical saber angle)
  index 2 – x / RUD (horizontal saber angle)

Usage:
  ros2 launch wrist_games_ros2 jedi_game.launch.py
  ros2 launch wrist_games_ros2 jedi_game.launch.py ros_topic:=/wrist/joint_states
"""
